const races = [
    {name: "Human"},
    {name: "Half-elf", DX: 1, BT: 1, CN: -1, MagickApt: 5, Repair: -1, Firearms: -1, PickLocks: -1, DisarmTraps: -1},
    {name: "Half-orc", ST: 1, CN: 1, Melee: 2, Dodge: 2, PRes: 10, BT: -2, CH: -2},
    ...
    {name: "Half-ogre", ST: 4, ResistDamage: 10, IN: -4, BT: -1, Prowling: -2}
];
